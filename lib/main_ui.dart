...
// import 'package:jotm_radio/theme.dart';
...
//       border: Border.all(
//         color: borderColor ?? AppTheme.of(context).secondaryBackgroundColor, // Default to theme color
//         width: borderWidth,
//       ),
...
//         color: iconColor ?? AppTheme.of(context).info, // Default to theme color
//         size: iconSize,
//       ),
//       onPressed: onPressed,
...
//                         colors: [
//                           AppTheme.of(context).secondaryTextColor,
//                           AppTheme.of(context).primaryTextColor
//                         ],
//                         stops: [0.0, 0.5],
...
//                         //       ElevatedButton.icon(
//                         //         onPressed: () async {
//                         //           // Showing the bottom sheet asynchronously
...
//                         //                     children: <Widget>[
//                         //                       const Text('BottomSheet Content'),
//                         //                       ElevatedButton(
//                         //                         child: const Text(
//                         //                             'Close BottomSheet'),
//                         //                         onPressed: () {
...
//                         //           // After the BottomSheet is closed, you can perform other tasks
...
//                                 iconSize: 24,                                
//                                 iconColor: AppTheme.of(context).secondaryBackgroundColor,
//                                 onPressed: () async {
...
//                                 height: 380.0,
//                                 decoration: BoxDecoration(
//                                   color: AppTheme.of(context).secondaryBackgroundColor,
...
//                         //                 Icons.share,
//                         //                 color:
//                         //                     AppTheme.secondaryBackgroundColorColor,
//                         //                 size: 24.0,
//                         //               ),
//                         //               onPressed: () {
